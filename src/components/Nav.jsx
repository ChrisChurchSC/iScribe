...
const Logo = () => (
  <svg width="112" height="15" viewBox="0 0 149 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const NAV_LINKS = [
  {
    label: 'Product',
    menu: [
      { title: 'Ambient Scribe', desc: 'AI notes from every visit' },
      { title: 'EHR Integration', desc: 'Syncs with Epic, Cerner & more' },
      { title: 'Smart Templates', desc: 'Notes in your preferred format' },
      { title: 'Security', desc: 'HIPAA compliant, SOC 2 certified' },
    ],
  },
  {
    label: 'Use Cases',
    menu: [
      { title: 'Outpatient', desc: 'SOAP notes before the patient leaves' },
      { title: 'Telehealth', desc: 'Notes ready the moment the call ends' },
      { title: 'Inpatient', desc: 'Filed before you leave the floor' },
      { title: 'Emergency', desc: 'Keep pace in high-volume settings' },
    ],
  },
  {
    label: 'Solutions',
    menu: [
      { title: 'For Physicians', desc: 'Win back hours every day' },
      { title: 'For Health Systems', desc: 'Scale across every department' },
      { title: 'For Groups', desc: 'Standardize documentation' },
    ],
  },
  { label: 'Resources' },
  { label: 'Company' },
